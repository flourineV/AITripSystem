...
export default function ModalLogin({ open, onClose, onSuccess }: { open: boolean, onClose: () => void, onSuccess: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm relative animate-fadeIn">
        ...
        >
          ...
          {error && <div className="text-red-500 text-center">Đăng nhập thất bại</div>}
        </form>
      </div>
    </div>
  );
